...
def define_and_train(iteration, model_name, load_for_inference, failout_survival_setting, training_data, training_labels, val_data, val_labels, epochs, batch_size, input_shape, num_classes, hidden_units, verbose):
    ...
    model_file = 'models/' + str(iteration) + " " +mux_adds_str+ str(failout_survival_setting) + 'camera_failout_rate.h5'
    ...
    for iteration in range(1,num_iterations+1):   
        ...
        for reliability_setting in reliability_settings:
            if reliability_setting == [1,1,1,1,1,1,1,1]:
                ...
                continue
            ResiliNet_failout_rate_variable = define_and_train(iteration, "Variable Failout 1x", load_for_inference, reliability_setting, training_data, training_labels, val_data, val_labels, epochs, batch_size, input_shape, num_classes, hidden_units, verbose)
        ...
        for failout_survival_setting in failout_survival_settings:
            ResiliNet_failout_rate_fixed = define_and_train(iteration, "Fixed Failout 1x", load_for_inference, failout_survival_setting, training_data, training_labels, val_data, val_labels, epochs, batch_size, input_shape, num_classes, hidden_units, verbose)
