...
def define_ResiliNet_MLP(input_shape,
    ...
    # failout definitions
    edge_failout_lambda, fog_failout_lambda = MLP_failout_definitions(failout_survival_setting)
    ...
    # fog node 2
    fog2_output = define_MLP_ResiliNet_architecture_fog2(edge1_output, edge2_output, edge3_output, edge4_output, fog3_output, fog4_output, hidden_units, fog_failout_lambda[3], fog_failout_lambda[4], multiply_hyperconnection_weight_layer)
    fog2_output = fog_failout_lambda[2](fog2_output)

    # fog node 1
    fog1_output = define_MLP_ResiliNet_architecture_fog1(fog2_output, fog3_output, fog4_output, hidden_units, fog_failout_lambda[2], multiply_hyperconnection_weight_layer)
    fog1_output = fog_failout_lambda[1](fog1_output)

    # cloud node
    cloud_output = define_MLP_ResiliNet_architecture_cloud(fog2_output, fog1_output, hidden_units, num_classes, fog_failout_lambda[1], multiply_hyperconnection_weight_layer)
...
def define_MLP_ResiliNet_architecture_fog2(edge1_output, edge2_output, edge3_output, edge4_output, fog3_output, fog4_output, hidden_units, fog3_failout_lambda, fog4_failout_lambda, multiply_hyperconnection_weight_layer = None):
    if multiply_hyperconnection_weight_layer == None or multiply_hyperconnection_weight_layer["e1f2"] == None or multiply_hyperconnection_weight_layer["e2f2"] == None or multiply_hyperconnection_weight_layer["e3f2"] == None or multiply_hyperconnection_weight_layer["e4f2"] == None or multiply_hyperconnection_weight_layer["f3f2"] == None or multiply_hyperconnection_weight_layer["f4f2"] == None:
        fog2_input_left = Lambda(InputMux(fog3_failout_lambda.has_failed),name="node3_input_left")([edge1_output, fog3_output]) 
        skip_hyperconnections = add([edge2_output, edge3_output, edge4_output])
        fog2_input_right = Lambda(InputMux(fog4_failout_lambda.has_failed),name="node3_input_right")([skip_hyperconnections, fog4_output]) 
    else: 
        fog2_input_left = Lambda(InputMux(fog3_failout_lambda.has_failed),name="node3_input_left")([multiply_hyperconnection_weight_layer["e1f2"](edge1_output), multiply_hyperconnection_weight_layer["f3f2"](fog3_output)]) 
        ...
        fog2_input_right = Lambda(InputMux(fog4_failout_lambda.has_failed),name="node3_input_right")([skip_hyperconnections, multiply_hyperconnection_weight_layer["f4f2"](fog4_output)]) 
...
def define_MLP_ResiliNet_architecture_fog1(fog2_output, fog3_output, fog4_output, hidden_units, fog2_failout_lambda, multiply_hyperconnection_weight_layer = None):
    if multiply_hyperconnection_weight_layer == None or multiply_hyperconnection_weight_layer["f2f1"] == None or multiply_hyperconnection_weight_layer["f3f1"] == None or multiply_hyperconnection_weight_layer["f4f1"] == None:
        ...
        fog1_input = Lambda(InputMux(fog2_failout_lambda.has_failed),name="node2_input")([skip_hyperconnections, fog2_output]) 
    else:
        ...
        fog1_input = Lambda(InputMux(fog2_failout_lambda.has_failed),name="node2_input")([skip_hyperconnections, multiply_hyperconnection_weight_layer["f2f1"](fog2_output)]) 
