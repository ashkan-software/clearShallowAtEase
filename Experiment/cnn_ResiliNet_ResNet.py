...
from Experiment.cnn_Vanilla_ResNet import imagenet_related_functions, define_cnn_architecture_cloud, define_cnn_architecture_fog
...
# ResiliNet
def define_ResiliNet_CNN_ResNet(input_shape=None, classes=10, block='bottleneck', residual_unit='v2',
