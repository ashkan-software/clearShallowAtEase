...
from Experiment.common import average, make_output_dictionary_average_accuracy, save_output, make_results_folder
import gc
import numpy as np
...
if __name__ == "__main__":
    ...
    DFG_no_information_flow_map = make_no_information_flow_map("ResNet", default_skip_hyperconnection_config)
